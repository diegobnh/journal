...
df.plot(x="app_name", y=["pmem_tlb_miss_30"], kind="bar", ax=axarr[0], color=['lightsalmon'])
df.plot(x="app_name", y=["pmem_tlb_miss_50"], kind="bar", ax=axarr[1], color=['lightsalmon'])
df.plot(x="app_name", y=["pmem_tlb_miss_70"], kind="bar", ax=axarr[2], color=['lightsalmon'])
...
axarr[0].legend(["NVM TLB miss"], ncol=2, loc='best', bbox_to_anchor =(1, 1.7))
