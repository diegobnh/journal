...
df["Pressure_50"] = round(df["Pressure_50"]/df["Pressure_30"], 2)
df["Pressure_70"] = round(df["Pressure_70"]/df["Pressure_30"], 2)

df.drop("No_pressure", axis=1, inplace=True)
df.drop("Pressure_30", axis=1, inplace=True)
